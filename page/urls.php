...
$urls = [
	'大陆镜像'	=> [
		'shizu-hrt-guide_mirror'	=> [
			'title'	=> 'Shizu\'s HRT Guide (大陆镜像)',
			'desc'	=> '非盈利性质的Shizu\'s HRT Guide的中国大陆镜像站，提供原站全内容的国内镜像。(注:该站点所用服务器处于中国大陆境内，非不可抗力情况下会尽量保持正常运行)',
			'url'	=> 'https://hrt.qwq.pink/'
		],
		'mtf-baike'	=> [
			'title'	=> 'MtF 百科',
			'desc'	=> '非盈利性质的MtF Wiki的中国大陆镜像站，提供简/繁体中文内容的国内镜像。(注:该站点所用服务器处于中国大陆境内，非不可抗力情况下会尽量保持正常运行)',
...
?>
<?php foreach($urls as $category => $urlList){ ?>
	<h1><?=$category; ?></h1>
	<div class="img-text-list">
		<?php foreach($urlList as $id => $info){ ?>
